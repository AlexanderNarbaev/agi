# RELEASE-NOTES — v2 rebuild 2026-08-26

## Что пересобрано

Документация полностью переписана: новая структура `docs-v2/` (SpecDriven, без историчности, малые файлы + связи). Старая — архивируется в `docs-v2/archive/2026-08-pre-v2/`.
...
- Все новые файлы `docs-v2/` имеют header с changelog 2026-08-26 «v2 rebuild».
