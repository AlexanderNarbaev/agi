...
Preliminary CPU-замеры ×149 latency при fidelity .999 (EXP-009B 2026-08-25);
GPU-нога (EXP-009C 2026-08-26) — см. текстовые ссылки в источниках.
...
- EXP-009C требует torch+CUDA, EP для Java-ONNX (`onnxruntime_gpu`) —
  отдельный prereq (на 2026-08-26 недоступно: «Failed to find CUDA
  shared provider»).
