...
|---|---|---|
| **H-010** — WiSARD WNN vs TsetlinTrainer в пределах 2 п.п. точности при ≥10× скорости | **accepted (synthetic-scope )** | EXP-010-report: 9 прогонов, median 242×, WiSARD 9/9 по точности |
| **H-002** — CLAUSESET (Tsetlin) бьёт MPDT-GA на quality×bytes при ≥10× скорости | **refuted-toy ** | EXP-002: GA быстрее ×5.5, точнее до +8.75 п.п., компактнее ×7500 |
| **H-003** — ни один «живой» обучатель (GA/three-factor) не оправдан против Tsetlin | **refuted-toy ** | EXP-002/003 протокол сходимости: GA to99 за 346 vs Tsetlin 673 в среднем |
...
| H-035 — EBL speeds convergence ≥2× | refuted-toy | EBL ×17 медленнее, опровергнуто на XOR |
