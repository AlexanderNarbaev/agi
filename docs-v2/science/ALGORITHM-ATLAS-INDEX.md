...
```
docs-v2/archive/2026-08-pre-v2/science/science/
├── ALGORITHM-ATLAS.md              # §1..§23 (мини-MPDT-нейрон, обучающие автоматы, федеративные схемы)
...
Прямое встраивание §1..§112 в новую компактную структуру увеличит docs-v2/ в десятки раз и противоречит директиве «компактные файлы и связи, исключая историчность». Это **реестр алгоритмических работ проекта** — материал для будущих research-волн и preregistration, но не «нормативная спецификация».
