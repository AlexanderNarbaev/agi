...
| [science/ALGORITHM-ATLAS.md](science/ALGORITHM-ATLAS.md) | Атлас алгоритмических школ, том 2: индийские школы (Navya-Nyāya, Махаланобис/ISI), категорная теория композиции, квантовая query-сложность булевых функций (QuantumBackend), сотовые автоматы и программируемая материя (Тоффоли–Марголус), резервуарные вычисления (intESN), школы академий СНГ (Ташкент: Романовский, Аюпов, Кабулов–Норматов; Тбилиси: Эсакиа; нормальные алгоритмы Маркова) — с операционным переносом, честными границами, H-015/H-016 |
...
| Документ | Назначение |
|---|---|
| [research/HYPOTHESES.md](research/HYPOTHESES.md) | Пререгистрированные гипотезы H-001…H-016 и карточки экспериментов EXP-001…016 |
