...
## Финал волны 25 (2026-08-24)
- **EXP-002 stage-1 закрыт**: D2-boost + EBL-курикулум дают сходимость+обобщение на k=8/12 (mean bAcc ≥0.80, 5 сидов). Следующий шаг — доменная фаза карточки.
